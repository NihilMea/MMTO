...
mmtop = MMTOProblem(fea, [mat.E for mat in mats], 3.0, 0.5, 20.0)
set_region!(mmtop, :passive, Point2D(2l / 5, 2l / 5), Point2D(l, l))
set_region!(mmtop, :fixed, Point2D(l - 6.0, 2l / 5 - 3.0), Point2D(l, 2l / 5))
...
# save("test/dens_plot.png",fig1)
fig2 = display_solution(:VM_Stress, sol, mmtop, x; s_max=[mat.S for mat in mats])
# save("test/stress_plot.png",fig2)
